...
class Events extends Component {
  ...
  getActiveRegistrationStatus = () => {
    ...
    const activeId = eventsList.find(each => each.id === activeEventid)
    if (activeId) {
      return activeId.registrationStatus
    }
    return ''
  }
    ...
    return (
      <div className="events-container">
        ...
        <ActiveEventRegistrationDetails
          getActiveRegistrationStatus={this.getActiveRegistrationStatus()}
        />
      </div>
    )
  }
